...
**Created:** 2026-06-25  •  **Updated:** 2026-07-08 (provocations-index CLOSED — ghost-row fix deployed, rendered_len 7671; next = provocation-card mini-lobby trim)
...
## >>> YOU ARE HERE (2026-07-08 — provocations-index CLOSED; next = provocation-card mini-lobby trim) <<<
