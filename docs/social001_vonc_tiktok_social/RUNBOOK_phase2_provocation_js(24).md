...
**Created:** 2026-06-25  •  **Updated:** 2026-07-07 (single YOU ARE HERE; revert decision; build eb3cdf42 complete — verification gate + Step 4)
...
**THE ONE GATE (deliver these three artifacts, then Step 4):**
```sql
...
**Then Step 4 (pack ready in outputs, run order):**
