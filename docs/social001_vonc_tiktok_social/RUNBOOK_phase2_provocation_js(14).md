...
**Created:** 2026-06-25  •  **Updated:** 2026-07-04 (App. H — lobby-grid file destinations)
...
inline <script>: `...card.classList.remove('is-active');` then `});\` — stray backslash,
...
ship a truncated <script> (`});\`, no </script>) → passed validation → stored → broke
