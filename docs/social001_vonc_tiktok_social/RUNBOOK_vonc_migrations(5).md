...
- [ ] **Deploy code** — four Go files need deploying to cluster
- [ ] **Regenerate `gauntlet-cta`** — 0 template slots, needs `needs_component_regeneration`
- [ ] **Regenerate `system-stats`** — 0 template slots, needs `needs_component_regeneration`
- [ ] **Rebuild index** — after gauntlet-cta and system-stats regenerate, rebuild index to fill those sections
- [ ] **Check tool page renders** — confirm tool-gauntlet and tool-archetype-taster-quiz look correct after rerenders
