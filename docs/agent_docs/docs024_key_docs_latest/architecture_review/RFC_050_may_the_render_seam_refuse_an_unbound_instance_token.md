...
| **b** | **Refuse fleet-wide, unconditional** (what was withdrawn) | Answers the defect completely. Is new authority on a seam with 12 call sites, licensed only by a census that cannot bound a future caller — the guardian's objection, unaddressed. |
