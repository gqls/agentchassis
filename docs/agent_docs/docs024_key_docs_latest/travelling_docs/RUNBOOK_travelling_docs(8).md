...
**Created:** 2026-07-04
**Last updated:** 2026-07-06 (rev 9 — guideline compliance pass: error_step-in-config fix re-drafted into the Stage-3 migration; Stage-4 caution on step-level error_step; Runner P0 pinned to the 035 envelope; helper tests drafted)
...
**Stage 3 ⏳ wiring migration RE-DRAFTED 2026-07-06 (error_step-in-config fix) —
re-pull `drafts/0NN_wire_persist_diagnosis_note.sql`, then apply + trigger** ·
