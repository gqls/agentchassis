...
**Created:** 2026-07-04
**Last updated:** 2026-07-04 (rev 4.2 — four actions ON PRODUCTION; Stage 3 wiring next)
**Status:** Phase A in rollout — tables live; four actions ON PRODUCTION 2026-07-04; wiring (Stage 3) next (RUNBOOK §0 tracker). This document is the spec.
