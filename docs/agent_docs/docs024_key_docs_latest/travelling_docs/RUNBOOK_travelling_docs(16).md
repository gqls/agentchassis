...
**Created:** 2026-07-04
**Last updated:** 2026-07-06 (rev 17 — 3b.1 paste received; 3b migration DRAFTED (mapping merge + BOTH contracts' optionals); 084 gains SUBJECT_TYPE/SUBJECT_KEY; positive-run recipe in 3b.4)
...
**Position as of 2026-07-06 (later): 3a CLOSED ✓ · 3b DRAFTED**
Stages 0–2 ✅ · 3a ✅ · 3b.1 ✅ (definitions pasted) · **3b.2 migration DRAFTED
(`drafts/0NN_wire_diagnosis_subject_threading.sql`) —
▶ NEXT: apply it (3b.3 verify), then the 3b.4 positive run:**
...
**3b.2 — migration DRAFTED:** `drafts/0NN_wire_diagnosis_subject_threading.sql`
