...
**Last updated:** 2026-07-09 (rev 43 — HANDOFF written for a fresh chat + bundle script. Facts settled: pages.sections is EMPTY for the game (body only in the deployed repo + adoption crawl); spec.mode = "recreate")
