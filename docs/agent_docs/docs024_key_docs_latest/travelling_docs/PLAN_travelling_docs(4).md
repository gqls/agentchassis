...
**Created:** 2026-07-04
**Last updated:** 2026-07-04 (rev 4.1 — rollout: gates clean, migration APPLIED, pipeline subject keys recorded)
**Status:** Phase A in rollout — gates run and migration APPLIED 2026-07-04 (tables live); Go actions deploying; wiring next (RUNBOOK §0 tracker). This document is the spec.
