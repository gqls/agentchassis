...
**Last updated:** 2026-07-09 (rev 36 — memory-growth hypothesis DISCONFIRMED (192 kB, 2 raw_message copies) → OOM points at a slow chassis leak over 2d19h, not index_plan. Real ids listed; PLAN supersede + correction NOTES drafted)
...
**Remedy drafted — `drafts/0NN_supersede_xp_curve_plan_selectors.sql`:**
