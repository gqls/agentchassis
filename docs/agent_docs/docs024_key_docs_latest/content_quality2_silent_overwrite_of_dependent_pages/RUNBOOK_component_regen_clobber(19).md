...
- [ ] **F3** — Code applied in repo ✔ (verified byte-level) · **F3c config applied ✔** (2026-07-02, all 5 keys verified, snapshot v6) · pending: **v1.0.1087 live on pods + image_tag rows** (building now) — F3 complete once confirmed
