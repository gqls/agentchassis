...
- [ ] **R6 (last recovery step)** — Eyeball the bands on the LIVE deploys (git → Actions → Backblaze already ran as part of page-rerender): leopardessconsulting.co.uk/index.html · robot-hands.com/index.html · robot-hands.com/entities/gripper-detail.html · ai-agent-orchestration.com/index.html · ai-agent-orchestration.com/case-study-kafka-consumer-group-remediation.html — expect the system-stats band with per-site stats and a "View full report" button → /contact.html
