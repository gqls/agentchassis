...
- [ ] **R5b** — Branch B CONFIRMED (bare substitution; resolver convention read from plan_sections). Steps: pick real per-site CTA urls (pages.url) → insert 3 `cta` aspects → re-trigger C2 → R6b
