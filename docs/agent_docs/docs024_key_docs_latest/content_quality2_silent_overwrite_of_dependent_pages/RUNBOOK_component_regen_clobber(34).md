...
- [ ] **R6e — brief-explanation contamination (pinned 2026-07-03).** Shared `brief-explanation` gauntlet-ified
...
- [ ] **R6f — theming: defined-vs-consumed variable drift.** styles.css defines the vars (:root ×2, --color- ×60);
