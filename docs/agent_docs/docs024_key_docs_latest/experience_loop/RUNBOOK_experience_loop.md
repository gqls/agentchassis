...
| T3 planner+council | **LIVE 2026-07-18, ESCALATED (correctly)** — loop proven end-to-end on v1.0.1135; 4 runner defects fixed (6c5dc9e13); 2 runs escalated at the revise cap. Blocker is an OWNER DECISION: feasibility HIGH says D2 (static per-provocation pages) needs an unproven page-type render path. Decision menu A/B in RUNNING_NOTES. | corr 7f4b224b (3 rounds), 6a4710d2 (5 rounds) |
| T4–T5 | not started | — |
