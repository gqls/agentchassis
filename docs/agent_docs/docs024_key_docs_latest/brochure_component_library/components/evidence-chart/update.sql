...
-- Re-apply evidence-chart's template + input_schema to the LIVE content_components row.
...
DROP TABLE IF EXISTS bak_cc_evidence_chart_pre_update;
CREATE TABLE bak_cc_evidence_chart_pre_update AS
SELECT * FROM content_components WHERE function = 'evidence-chart';
