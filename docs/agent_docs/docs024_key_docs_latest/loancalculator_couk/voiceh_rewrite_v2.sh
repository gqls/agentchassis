...
CANARY_ITEM='4a9edd45-4dee-4c70-96af-374570e683ee'   # guidance v2: conditional-opening mandate removed (owner 2026-08-08)
PAGE_NAME="$1"
...
SELECT '$SITE_ID', 'voiceh-rollout', 'content_rewrite', 'medium',
       ...
       'page-build-handler', 'voiceh-v2:$PAGE_NAME', 50
