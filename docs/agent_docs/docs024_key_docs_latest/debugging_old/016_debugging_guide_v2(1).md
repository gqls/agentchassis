...
## 10. Adapter & Service Deployment Issues
...
### 10.1 ImagePullBackOff — `insufficient_scope: authorization failed`
...
### 10.2 Container crashes immediately: `exec: "--config": executable file not found`
...
### 10.3 Adapter starts but `Unknown Topic Or Partition` on first message
...
### 10.4 Deployment essentials checklist (every new adapter)
...
## 11. Quick Health Dashboard Query
