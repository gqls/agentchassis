# SUMMARY — 2026-08-21 — the work-item terminal-write contract (bugs_open/307 → closed)

*Written to be read aloud. The lane's first summary and, on current state, its last.*
