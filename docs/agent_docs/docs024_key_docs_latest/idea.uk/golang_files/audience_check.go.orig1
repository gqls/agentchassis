...
func renderAudienceHTML(business, statedAudience string, aud audienceResult) string {
	...
	if aud.CarriedAudience != "" {
		fmt.Fprintf(&b, "<h4>Our reframe — who you should actually be selling to</h4><p>%s</p>",
	...
	b.WriteString(`<p class="taster-footer">This is the first step of our full method. ` +
		`The paid report continues with idea generation across four lenses, a critique pass ` +
		`against the free AI alternative, web-verified findings, and ranked scoring including ` +
		`an operator-risk score. <a href="#request">Get the full report — £29 →</a></p>`)
	return b.String()
}
