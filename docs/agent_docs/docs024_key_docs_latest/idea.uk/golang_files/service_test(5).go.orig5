...
func TestRenderReadable(t *testing.T) {
	...
	riskDropped := []scored{{
		Title: "Suggest a likely diagnosis from a patient's notes", Defensibility: 4, Willingness: 5, Buildability: 3, Risk: 1,
		candidate: candidate{BeatsFreeBecause: "It reads a patient's notes and suggests what the most likely diagnosis might be."},
	}}
