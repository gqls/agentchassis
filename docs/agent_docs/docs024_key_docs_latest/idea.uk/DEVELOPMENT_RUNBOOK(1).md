...
- ⏳ End-to-end live run against real APIs (e.g. `go run . internal "agritec.uk" "UK small farmers" "curate scheme docs"`) pending operator decision when to spend the £1 to validate.
