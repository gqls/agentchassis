...
1. **Coordinator result-extraction — FIX IMPLEMENTED 2026-06-17 (`result_spec.go` + `coordinator.go`),
   NOT yet field-tested.** *Diagnosis (settled, git-confirmed):* the coordinator has read `output_fields`
