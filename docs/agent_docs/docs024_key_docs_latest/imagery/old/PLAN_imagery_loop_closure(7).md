...
Phase 2G is complete: all five substantive steps delivered or designed-and-packaged, plus the design-discovery-agent wiring. 2G.6 retired as originally scoped (the framing "detect sites on legacy" didn't survive review — see Decisions table). Phases 2H, 3, 4, 5, 6 of the outer plan not started.
