-- WRITE v2 of the acceptance-criteria fence: profile-gated so the run fits the
-- 120s runDeadline. Supersedes v1 (ce569cc0), which was correct but timed out in the
-- cluster on 36 evaluations. Mirrors write_doc_plan_action.go:94-110.
UPDATE doc_plans
