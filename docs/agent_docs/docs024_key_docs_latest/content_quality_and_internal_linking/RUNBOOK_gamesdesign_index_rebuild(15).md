...
-- 2. queue a section-re-rendering page_rerender — MIRROR the P2.3 Test 1 INSERT that worked
--    (same spec keys), swapping only the page:
--      page_id     = '8ed97fd2-2e33-4bdb-a24e-0f3badaca382'
--      page_name   = 'guide-economy-basics'
--      item_key    = 'page_rerender_guide-economy-basics_diag_p42'
--      spec.reason = 'image_landed'   (gates the rerender pre-pass, as in Test 1)
