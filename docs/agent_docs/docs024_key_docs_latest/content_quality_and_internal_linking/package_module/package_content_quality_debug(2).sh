...
MODULE_FILES=(
  ...
  "platform/orchestration/actions/reconcile_section_data_action.go"    # re-trigger query-resolvable deferred list data (June-02; registry entry pending)
  "platform/orchestration/actions/flag_page_image_rebuild_action.go"   # June-02; registry entry pending; referenced by live image-build-handler
