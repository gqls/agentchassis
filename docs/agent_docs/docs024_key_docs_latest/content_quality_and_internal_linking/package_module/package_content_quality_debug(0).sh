...
# --- Configuration ---------------------------------------------------
#DEFAULT_OUTPUT_DIR="$SCRIPT_DIR/docs/agent_docs/docs024_key_docs_latest/adoption/docubundle/adoption/package_module/output_contexts"
DEFAULT_OUTPUT_DIR="$SCRIPT_DIR/docs/agent_docs/docs024_key_docs_latest/adoption/docubundle/content_quality/package_module"
...
#
# >>> PROPOSED SET — CONFIRM/REPLACE per the doc search in chat. Names are
#     versioned; grab the HIGHEST version of each. Items marked (confirm) are
#     best-guess versions; the find-by-basename fallback tolerates wrong paths
#     but NOT wrong version numbers. <<<
DOCS_FILES=(
  # thread working docs (this session)
  "HANDOFF_2026-06-09_sections_durability_and_content_quality.md"
  "running_notes_15_skinner_box_and_adoption_sections.md"
  "FOCUS_page_build_handler_silent_completion.md"
  "RUNBOOK_section_sectionless_durability.md"
  # the gamesdesign defect list — THE source for this task (confirm latest version)
  "CATALOGUE_gamesdesign_post_sync_fix_defects(9).md"
  # component / interactive-demo context for guides (confirm exist / latest)
  "docs/agent_docs/docs024_key_docs_latest/019_tool_library.md"
  "docs/agent_docs/docs024_key_docs_latest/020_tool_lifecycle.md"
  # guidelines (the constitution) — confirm highest version of each
  ...
  "docs/agent_docs/docs024_key_docs_latest/016_debugging_guide_v2_35.md"  # confirm latest v2_NN
)
