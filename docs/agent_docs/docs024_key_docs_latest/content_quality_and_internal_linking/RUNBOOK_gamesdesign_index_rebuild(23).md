...
| 4 — interactive page clobber | Cause confirmed; P4.2 done (`page_rerender` ruled out) | **Layer 1 guard, then Layer 2 preserve interactive sections**; re-create `game-pathfinding` | Part 4 |
