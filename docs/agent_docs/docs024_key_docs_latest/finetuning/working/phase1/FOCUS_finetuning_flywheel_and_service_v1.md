...
## 8. Offer structure (three tiers)

| Tier | Offer | Price | Volume target |
|---|---|---|---|
| Lead | AI-built industry sites + ongoing content operations | £3-5k setup + £1.5-3k/mo | 2-3 clients |
| Middle | Custom AI assistant trained on business knowledge, hosted | £5-10k setup + £800-1.5k/mo | 1 client |
| High | Bespoke multi-agent workflow for a specific business process | £15-30k project + £500-1.5k/mo | 1 client |

Ratio at steady state: ~4 clients producing ~£9-11k/month with solo load.
...
Aspirational dates, not promises. Discipline = ship something real every
week even before the big thing is ready.

**This week**
- Reposition finetuning.uk via `site_specs` rewrite (identity,
  content_direction, strategy). Let the agent system regenerate core pages.
  Dogfood the framework.
- Publish 2-3 foundational articles ("Should you fine-tune?" decision
  guide first, using our own pipeline).
- "Book a diagnostic call" page live at £250/hr.

**Month 1**
- 2-3 free tools via the existing tool pipeline (decision tools, cost
  estimators, training-data readiness checker).
- Productised AI Site Audit at £750-1,500.
- First free newsletter issue.
- Pick up one interim gig to generate market signal.

**Month 2-3**
- Launch lead offer publicly.
- Partner directory v1 (10-20 providers, each personally vetted).
- Case studies from existing portfolio (gaswholesalers, leopardess,
  ai-agent-orchestration, vonc) with real numbers.

**Month 3-6**
- First retainer client closed from inbound.
- Middle offer launched.
- Paid newsletter tier or ebook at £49-199.

**Month 6-12**
- Retainer count grows to 3-4.
- High offer emerges as wedge.
- Income approaching £9-12k target.
