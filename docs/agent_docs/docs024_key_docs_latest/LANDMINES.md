...
- **footprint:** `platform/orchestration/actions/save_page_sections_action.go`, `save_sections_metadata_source.go`, `page_components.content_data`, the config keys `sections_metadata_field` / `expects_no_sections_metadata` / `require_sections_metadata`
