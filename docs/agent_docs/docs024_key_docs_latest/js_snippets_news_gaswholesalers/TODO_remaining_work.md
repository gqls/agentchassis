...
> Live backlog. Supersedes the 2026-05-20 snapshot. The detail docs referenced
> below have been consolidated: FAQ work → `FOCUS_faq_empty_items_and_page_content.md`;
> news/asset work → `FOCUS_news_rendering_and_component_assets.md`; CSS/component-list
> → `FOCUS_visual_pipeline_css_and_component_lists.md`; OOM/reapers →
> `FOCUS_platform_reliability_oom_and_reapers.md`; diagnostic methods →
> `016_debugging_guide_addenda.md`. Ordered by priority /
