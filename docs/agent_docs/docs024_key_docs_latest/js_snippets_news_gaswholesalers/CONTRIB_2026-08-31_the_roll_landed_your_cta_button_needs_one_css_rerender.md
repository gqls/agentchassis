...
| **gaswholesalers.com** | **still 1.00:1** |
...
```bash
curl -s https://gaswholesalers.com/assets/css/styles.css | grep -o -- '--color-cta-bg-ink:[^;]*'
scripts/render_audit.py https://gaswholesalers.com/about.html
```
