...
var HighlanderComments = jQuery.extend( HighlanderComments, {
	...
	init : function() {
		...
		pm.bind( 'googlePlusButtonClick', HighlanderComments.onGooglePlusButtonClick, 'https://web.archive.org/web/20160109025221/https://public-api.wordpress.com' );
		pm.bind( 'googlePlusSignIn', HighlanderComments.onGooglePlusSignIn, 'https://web.archive.org/web/20160109025221/https://public-api.wordpress.com' );
...
//		HighlanderComments.autosaveInterval = setInterval( HighlanderComments.autosaveComment, 10000 );
		...
		jQuery( 'textarea#comment' )
			...
			.one( 'focus', function() {
				pm( {
					target: jQuery( '#googleplus-sign-in' )[0].contentWindow,
					type: 'googlePlusLoadJS',
					data: 0,
					url: 'https://web.archive.org/web/20160109025221/https://public-api.wordpress.com'
				} );
			});
...
//		HighlanderComments.autosaveComment();
	...
	updateAvatarWithGravatar : function(e) {
		var grav_base = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20160109025221/https://secure' : 'https://web.archive.org/web/20160109025221/http://www' ) + '.gravatar.com/avatar/';
		if ( jQuery( e ).length ) {
			...
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' )
				.attr( 'src', function() {
					...
					try {
						...
						url = location.protocol + '//web.archive.org/web/20160109025221/https://i0.wp.com/' + host + '/' + path + '?';
	...
	doExternalCanceled : function( service, from_tab ) {
		if ( from_tab ) {
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' ).attr( 'src', ( 'https:' === location.protocol ? 'https://web.archive.org/web/20160109025221/https://secure' : 'https://web.archive.org/web/20160109025221/http://www' ) + '.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25&d=' + encodeURIComponent( HighlanderComments.gravDefault ) );
	...
	doExternalLogout : function( service ) {
		...
		if ( 'googleplus' == service ) {
			jQuery( 'body' ).append( '<iframe height="1" width="1" style="display:none;" src="https://web.archive.org/web/20160109025221/https://accounts.google.com/logout" />' );
		}
	},
...
/*
     FILE ARCHIVED ON 02:52:21 Jan 09, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:54:52 Jun 10, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.857
  load_resource: 535.021
  PetaboxLoader3.resolve: 452.842
  PetaboxLoader3.datanode: 77.615
*/