...
var HighlanderComments = jQuery.extend( HighlanderComments, {
	...
	init : function() {
		...
		pm.bind( 'googlePlusButtonClick', HighlanderComments.onGooglePlusButtonClick, 'https://web.archive.org/web/20160314052345/https://public-api.wordpress.com' );
		pm.bind( 'googlePlusSignIn', HighlanderComments.onGooglePlusSignIn, 'https://web.archive.org/web/20160314052345/https://public-api.wordpress.com' );
		...
		jQuery( 'textarea#comment' )
			...
			.one( 'focus', function() {
				pm( {
					...
					data: 0,
					url: 'https://web.archive.org/web/20160314052345/https://public-api.wordpress.com'
				} );
			});
...
//		HighlanderComments.autosaveComment();
	...
	updateAvatarWithGravatar : function(e) {
		var grav_base = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20160314052345/https://secure' : 'https://web.archive.org/web/20160314052345/http://www' ) + '.gravatar.com/avatar/';
		if ( jQuery( e ).length ) {
			...
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' )
				.attr( 'src', function() {
					...
					try {
						...
						url = location.protocol + '//web.archive.org/web/20160314052345/https://i0.wp.com/' + host + '/' + path + '?';
	...
	doExternalCanceled : function( service, from_tab ) {
		if ( from_tab ) {
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' ).attr( 'src', ( 'https:' === location.protocol ? 'https://web.archive.org/web/20160314052345/https://secure' : 'https://web.archive.org/web/20160314052345/http://www' ) + '.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25&d=' + encodeURIComponent( HighlanderComments.gravDefault ) );
	...
	doExternalLogout : function( service ) {
		...
		if ( 'googleplus' == service ) {
			jQuery( 'body' ).append( '<iframe height="1" width="1" style="display:none;" src="https://web.archive.org/web/20160314052345/https://accounts.google.com/logout" />' );
		}
	},
...
/*
playback timings (ms):
  capture_cache.get: 1.283
  load_resource: 287.263 (2)
  PetaboxLoader3.resolve: 110.188 (2)
  PetaboxLoader3.datanode: 108.483 (2)
*/