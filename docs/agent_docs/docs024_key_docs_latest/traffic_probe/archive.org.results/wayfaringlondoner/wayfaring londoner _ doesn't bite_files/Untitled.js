...
Scroller.prototype.refresh = function() {
	...
	jqxhr.done( function( response ) {
			...
			// If we've succeeded...
				...
				if ( stats )
					new Image().src = document.location.protocol + '//web.archive.org/web/20160314133329/https://pixel.wp.com/g.gif?' + stats + '&post=0&baba=' + Math.random();
...
JetpackSlideshow.prototype.onCyclePrevNextClick_ = function( isNext, i/*, slideElement*/ ) {
	...
	stats.src = document.location.protocol +
		'//web.archive.org/web/20160314133329/https://pixel.wp.com/g.gif?host=' +
  ...
  var
    ...
    /////////////////////////
      ...
      base: (location.protocol === 'https:' ? 'https:' : 'http:') +
            '//web.archive.org/web/20160314133329/https://twemoji.maxcdn.com/',
...
var JetpackEmoji = {
		EMOJI_SIZE: 72,
		BASE_URL: '//web.archive.org/web/20160314133329/https://s0.wp.com/wp-content/mu-plugins/emoji/twemoji/',
...
jQuery.extend({VideoPress: {
	error:{
		messages:{
			...
			freedom:'You do not have sufficient <a href="https://web.archive.org/web/20160314133329/http://www.gnu.org/philosophy/free-sw.html">Freedom levels</a> to view this video.',
			incompatible:'VideoPress requires either HTML5 video or <a href="https://web.archive.org/web/20160314133329/http://www.adobe.com/go/getflashplayer">Adobe Flash Player 10</a> or above for playback.',
	...
	analytics:{
		wpcom:{
			base_uri:"//web.archive.org/web/20160314133329/https://pixel.wp.com/v.gif?",
	...
	video:{
		flash:{
			...
			player_uri: ( 'https:' == location.protocol ? 'https://web.archive.org/web/20160314133329/https://v0.wordpress.com' : 'https://web.archive.org/web/20160314133329/http://s0.videopress.com' ) + "/player.swf?v=1.04",
			min_version:"10.0.0",
			params:{wmode:"direct",quality:"autohigh",seamlesstabbing:"true",allowfullscreen:"true",allowscriptaccess:"always",overstretch:"true"},
			expressinstall: ( 'https:' == location.protocol ? 'https://web.archive.org/web/20160314133329/https://v0.wordpress.com' : 'https://web.archive.org/web/20160314133329/http://s0.videopress.com' ) + "/playerProductInstall.swf",
...
wpcom.carousel = (function(/*$*/) {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20160314133329/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20160314133329/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
// @end-hide-in-jetpack
		...
		loadLikes : function ( attachmentId ) {
			...
			if ( $( '#like-post-wrapper-' + blogId + '-' + attachmentId ).length === 0 ) {
				...
				var protocol = 'http';
				var originDomain = 'https://web.archive.org/web/20160314133329/http://wordpress.com';
		...
		updateMap: function( meta ) {
			...
			$mapbox
				...
				.html( '<img width="154" height="154" src="https://web.archive.org/web/20160314133329/https://maps.googleapis.com/maps/api/staticmap?\
							...
							\
						<div class="gmap-topright"><div class="imgclip"><img width="175" height="154" src="https://web.archive.org/web/20160314133329/https://maps.googleapis.com/maps/api/staticmap?\
							center=' + latitude + ',' + longitude + '&\
							zoom=3&\
							size=175x154&\
							sensor=false&\
...
/*
     FILE ARCHIVED ON 13:33:29 Mar 14, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:54:47 Jun 10, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 1.804
  load_resource: 798.504
  PetaboxLoader3.resolve: 64.51
  PetaboxLoader3.datanode: 190.18
*/