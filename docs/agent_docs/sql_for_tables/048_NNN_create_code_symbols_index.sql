...
--
-- CONFIRMED (2026-06-09, clients_db): \dt found no existing *code* / *symbol* table,
-- and \dx shows vector 0.8.0 ("ivfflat and hnsw access methods") + pg_trgm 1.6 +
-- pgcrypto (gen_random_uuid). Both gates pass — HNSW stands; the IVFFlat fallback is
