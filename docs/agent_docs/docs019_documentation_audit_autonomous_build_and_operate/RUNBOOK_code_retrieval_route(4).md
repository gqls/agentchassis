...
- [x] CONFIRMED 2026-07-02: `git ls-remote origin HEAD` = 4c2c172bb3faee…;
      ...
      never advances.
- [ ] HEAD hygiene decided (see §7C ref strategy): either main becomes a
      deployed-pointer (CI fast-forwards main on deploy) or HEAD is simply
      never used as a ref anywhere (explicit refs in every envelope)
...
- [ ] envelope REF derived per the ref strategy (branch name or sha) — NOT "HEAD"
- [ ] spawn gate line added + spawning image rebuilt/deployed; spawned indexer
      pod shows GITHUB_READ_TOKEN (secretKeyRef)
