...
```
Growing 36710be count beside the static 436 old rows (prune runs at the END) ⇒
working. Static ⇒ check the ollama-adapter log (should scroll with embed
requests) and the agent-code-indexer pod log.
