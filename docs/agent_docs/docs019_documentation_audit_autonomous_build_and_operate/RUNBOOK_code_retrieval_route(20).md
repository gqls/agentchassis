...
>    DEPLOY ORDER: go test ./platform/orchestration/... → build → push →
>    deploy → THEN the rename migration → optional diagnose run to see the
>    warns gone and the flattened shape.
