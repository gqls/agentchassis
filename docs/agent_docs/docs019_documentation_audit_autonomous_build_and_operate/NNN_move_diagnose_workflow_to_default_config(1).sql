-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║ SUPERSEDED for diagnose-agent by NNN_fix_diagnose_agent_workflow.sql.       ║
-- ║ This file MOVES the seeded workflow to default_config — but the seeded      ║
-- ║ diagnose-agent workflow references a `diagnose_run` action that DOES NOT     ║
-- ║ EXIST. Moving it would still be broken. The fix migration instead REWRITES   ║
-- ║ diagnose-agent's workflow to the real (diagnose_route) shape AND moves the    ║
-- ║ orchestrator. Use the fix migration; do not apply this one.                  ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
--
