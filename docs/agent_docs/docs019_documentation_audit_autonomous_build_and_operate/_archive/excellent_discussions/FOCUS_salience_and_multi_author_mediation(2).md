...
### 9.7 Open sub-question (next)

How the **scope** of an entering change is decided and recorded — when a law, a piece of news, or a client instruction arrives, what determines which node it attaches to, and therefore how far it propagates. Getting the level right is the whole game for broad changes, and it is the one step that is not mechanical.
