...
type PageDescriptor struct {
    Role  string // "tool" | "guide" | "game" | "section_index" | "content" | "blog_post" | ...
...
| Role | name | url |
|---|---|---|
| `section_index` (section="tools") | `tools-index` | `/tools/index.html` |
...
- Planner can still emit pages that are conceptually identical to adopted
  ...
  adoption emitted `section_index/tools`). Ambiguity at the role level isn't
