...
- [ ] v2 seed migration applied; verify row shown
- [ ] branch 083_imagery PUSHED to GitHub (tarball/<branch> needs the remote tip)
- [ ] retrigger via index-orchestrator (fresh ids); agent-code-indexer pod
      appears; token visible on THAT pod; then §7C verification
