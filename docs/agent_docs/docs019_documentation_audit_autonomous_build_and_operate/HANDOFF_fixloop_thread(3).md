...
scopes resolved) — carry it into the project folder. THE PILOT BUG IS
CHOSEN: the dartsonline chrome/nav defect (runbook "F0 PILOT" section —
symptom, criteria, boundary note). First action: slice **F0.1** with
