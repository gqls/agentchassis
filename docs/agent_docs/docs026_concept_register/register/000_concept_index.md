...
| CTS-060 | Whole-tree search unique-or-nothing + `!` strict marker (RFC_029 Phase 1) | built | Search collects all matches, shallowest-first, conflict WARN (Phase 1) then refusal (Phase 2); `!` = explicit-or-fail, never the search. Inert until roll; 417 adopter migration HELD | contracts-and-standards.md |
