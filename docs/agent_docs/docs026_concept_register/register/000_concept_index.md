...
| SYS-090 | Fail-closed dispatch resolution for unresolvable orchestrate requests | built | An orchestrate request naming an unresolvable agent now refuses loudly instead of silently running the consumer pod's own no-op | system-architecture.md |
