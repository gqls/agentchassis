...
| VIZ-010 | cmd/contrastscan: the post-deploy contrast witness | built, unwired | Computed style + actual painted backdrop, alpha-composited. Complements AuditPalette; neither sees what the other sees | visualisation-and-charts.md |
