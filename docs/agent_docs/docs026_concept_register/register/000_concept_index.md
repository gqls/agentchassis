...
| CQ-021 | ScanDeployedClaims — claims audit shared by check and revalidator | LIVE + PROVEN (8 closures); claim-granular gate built 2026-08-12, awaiting roll; council r1–r5 REVISE, 14/16 approve at r5 | claims_unverified items can now be auto-retracted; ONE producer (entry first said TWO — corrected); a close requires BOTH that the page moved AND that every cited text has gone from its own slot — the seat's own snippet-based suggestion was measured (18/41 vs 40/41) and rejected as failing OPEN | content-quality.md |
