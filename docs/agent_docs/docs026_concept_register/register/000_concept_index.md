...
| CQ-020 | ScanVoiceTells — voice audit shared by check and revalidator | built, inert until roll | voice_tells items can now be auto-retracted; the gate is a moving standard, so a close does not prove the copy changed | content-quality.md |
