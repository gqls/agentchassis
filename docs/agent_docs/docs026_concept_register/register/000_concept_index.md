...
**1,792 index table rows** — re-measured 2026-08-08 (18:35 UTC) after adding the
missing `SCH-024` row, and the pair is clean: **1,792 rows, 1,792 unique entry
ids, 0 orphans either way.**
