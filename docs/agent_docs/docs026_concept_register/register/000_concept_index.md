...
| SYS-091 | Database pool instrumentation (go_sql_* incl. wait counters) | built | Every pool agentbase opens now reports its configured size and its contention — the instrument bugs_closed/246 had to be argued without | system-architecture.md |
