...
**1,784 index table rows** — re-grepped 2026-08-06 after **DOC-075** (`prove-live-markers`, row and entry in one commit), and the pair was clean: 1,784 rows, **1,784 unique entry ids**, no duplicate and no orphan. Previously 1,783 — re-grepped 2026-08-06 after PBP-035 with `grep -c "^| [A-Z][A-Z]*-[0-9]" 000_concept_index.md`; PBP-035 added ONE and one more arrived from a concurrent lane between this recount and the 1,781 above it, which is why you re-grep and never carry this number — 1,758 measured clean 2026-08-04 after DOC-074
