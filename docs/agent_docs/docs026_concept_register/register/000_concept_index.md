...
**1,781 index table rows** (re-grepped 2026-08-06 after IMG-068; the earlier same-day recount said 1,771, and this row added ONE — the other ~9 arrived from concurrent lanes between recounts, which is why you re-grep and never carry this number) — 1,758 measured clean 2026-08-04 after DOC-074
