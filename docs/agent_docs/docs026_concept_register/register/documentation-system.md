...
- **status:** **submitted, NOT live** (2026-07-30) — Go + migration written and committed, council correlation `e5673868-7c5b-489c-931a-7ba59b959b91`, **migration 273 deliberately NOT applied** and inert until an image carries the Go half. Registered now, in the shipping commit, because it is a shared-vocabulary seam (CLAUDE.md platform-seams condition 2), not because it works yet.
