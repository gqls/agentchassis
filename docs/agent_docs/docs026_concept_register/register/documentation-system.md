...
- **status:** **built, DB-applied, CONFIRMED end to end live on `v1.0.1215`, auto-dispatch wired.** RFC_005 §3.2 is now fully done; only §3.3 (the weekly `bugs_open/` staleness sweep, a separate mechanism) is unstarted.
