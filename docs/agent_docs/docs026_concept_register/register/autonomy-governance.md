...
- **verify-later:** stage B ships opt-in default OFF per the 08-02 seam ruling and warrants the architecture round the council's r2 note anticipated (shed_level becomes a read every claiming type depends on)
