...
autonomy-governance register for the fuller, later versions of the trust-ledger and
change-layer contracts) — pure design framing, nothing built, except where noted.

### ABO-001 — trust ledger (bidirectional trust ratchet, per-tenant per-capability) — earlier draft
- **status:** aspirational
- **status-evidence:** "Status: contract specification... Now given concrete shape." — a design document, no implementation claimed. A later/fuller version of this exact contract exists live as AGOV-004 (docs019 PLAN_trust_ledger_contract(4).md), outside this unit's original scope.
...
- **relations:** trust ledger (ABO-001); reuse-check retrieval pipeline (reuse_index_refresh trigger); change-layer integration (AGOV-006, the fuller live version)
- **verify-later:** any change_events table in the live schema

### ABO-003 — context substrate model (authored vs derived, salience over presence)
- **status:** aspirational
...
- **relations:** contextkit toolchain; flat-file constitution; salience over presence (reasoning register, RSN-002)
- **verify-later:** none (a design framing, not a built artifact)

### ABO-004 — mediator model for competing design concerns ("right" as requirement-relative balance)
- **status:** aspirational
...
- **relations:** trust ledger (ABO-001); change-layer integration contract (ABO-002); mediator model (ABO-004); confirm-not-initiate + central confirmer (autonomy-governance register, AGOV-001)
- **verify-later:** none (a design framing, not a built artifact)

### ABO-006 — autonomous-system building-block hardening checklist
- **status:** aspirational
...
- **relations:** trust ledger (ABO-001); change-layer integration contract (ABO-002); external rollback + residual risk (autonomy-governance register, AGOV-010)
