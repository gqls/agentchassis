...
- **status:** built and live in ONE caller; the ratchet and its advisory twin are live tree-wide. Committed `7c443aac6` (2026-08-26), inert until the chassis rolls for the Go half; the `pattern-check.py` half is live immediately (it runs from the working tree on every commit).
