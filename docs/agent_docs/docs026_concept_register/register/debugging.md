...
- **status:** built 2026-08-22, run against real history. Hand-run (`scripts/audit-advisory-findings.py`); the CronJob is **NOT built and is not a wiring detail** — see verify-later. It answers a question that had been open and unanswerable since 2026-08-02.
