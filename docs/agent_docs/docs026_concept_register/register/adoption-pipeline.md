...
- **sources:** `scripts/class_count_delta.py` (`6427f157f`), `bugs_open/263`, `WRONG_CALLS.md` 2026-08-12 (the netting-out aggregate, and the empty-read that nearly removed the code-stripping)
