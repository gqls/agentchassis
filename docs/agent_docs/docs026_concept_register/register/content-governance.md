...
- **status:** **DEPLOYED AND PROVEN IN THE CLUSTER, 2026-08-04** — daily CronJob `component-render-check` (06:55 UTC), image `docker.io/aqls/component-render-check:v1.0.1250`, baseline `go:embed`-ed into the binary. Advisory in the sense that matters: it fails ONLY on a NEW or UNCOVERED finding, never on the ~1,000-strong census
