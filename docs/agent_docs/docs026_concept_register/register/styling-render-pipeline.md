...
- **status:** DB half LIVE (mig 357 applied + four-arm probe-verified 2026-08-09); Go half committed, inert until the next chassis image. Council corr `eee2888b-20dc-46ba-9b1f-53e592374cba` (submitted before commit; resolves at 098 report time).
