...
- **status:** aspirational
- **status-evidence:** Phase-1 diagnostics confirmed "a clean slate — nothing exists yet" (2026-06-25); FX-4 checkbox never ticked; provocations.json still hand-committed as of 2026-07-09; RUNNING_NOTES_minilobby 2026-07-11 confirms it is still missing: "There is no Phase-3 emitter yet; all prior commits to the file were hand-made."
