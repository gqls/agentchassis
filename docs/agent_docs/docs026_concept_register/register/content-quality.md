...
- **verify-later:** whether the fact-census floor of 6 is the right number; whether any site other than vonc has content-identical rows once the check is enabled fleet-wide
- **landmines:**
