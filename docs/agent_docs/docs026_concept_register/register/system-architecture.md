...
- **status:** LIVE in the binary since v1.0.1293 (2026-08-12) and serving correctly — but **NOT scraped on the chassis until the next roll applies the manifest fix below.** ~~built 2026-08-12, NOT yet live (inert until the next fleet roll — Go change). The scrape path it rides on IS live and was verified before building.~~
