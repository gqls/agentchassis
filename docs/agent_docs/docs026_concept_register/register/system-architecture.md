...
- **status:** built 2026-08-25, **Go INERT until the next core-manager roll**; box vhost repointed in the same commit but **deliberately not applied until the roll** (the file says so in its header). Council submitted with the commit.
