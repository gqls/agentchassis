...
- **status:** built, not yet live (fixed 2026-07-31, inert until the next chassis roll)
- **status-evidence:** Filed 2026-06-12: "This path maps NO db_sync to the writer → prepare_link_context/available_pages get nothing … Pre-existing, resolver-independent". Still 100% seven weeks later — 26 of 26 page-content-writer runs at `page_count 0`, latest 2026-07-31 15:36 UTC. Fixed in commit `2e1bfb39e` (`bugs_open/092`), council `4b8c5e21-011b-40f0-819a-3dfa4b4c7b1d`.
...
- **sources:** running_notes_17(21).md#page-build-handler-contract watch items; bugs_open/092; docs024_key_docs_latest/bugfix_092_writer_link_constraints/
...
- **sources:** bugs_open/092 trap 1; commit `2e1bfb39e`
