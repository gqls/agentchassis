-- 702 ROLLBACK: delete the successor, restore the predecessor (the 697 row).
...
BEGIN
  DELETE FROM site_specs WHERE site_id='55213ded-03ec-40f7-8fc1-169de05e05c8' AND aspect='evidence_base'
    AND created_by='loanzy_uk_example_site lane (migration 702)' AND is_current;
  GET DIAGNOSTICS n = ROW_COUNT;
  IF n <> 1 THEN RAISE EXCEPTION '702 rollback: expected 1 successor, deleted %', n; END IF;
