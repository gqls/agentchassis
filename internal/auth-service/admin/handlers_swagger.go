...
// @Success      200 {object} UserListResponse "List of users retrieved successfully"
...
// @Produce      json
// @Param        user_id path string true "User ID"
// @Param        request body GrantPermissionRequest true "Permission details"
...
// @Accept       json
// @Produce      json
// @Param        request body BulkUserOperation true "Bulk operation details"
// @Success      200 {object} map[string]interface{} "Bulk operation results"
// @Failure      400 {object} map[string]interface{} "Invalid request body"
// @Failure      401 {object} map[string]interface{} "Unauthorized - no valid token"
// @Failure      403 {object} map[string]interface{} "Forbidden - admin access required"
// @Failure      500 {object} map[string]interface{} "Internal server error"
...
// @Param        request body UserExportRequest true "Export configuration"
...
// @Success      200 {object} UserImportResult "Import results with created user IDs"
...
// @Produce      json
// @Param        user_id path string true "User ID"
// @Param        request body TerminateSessionsRequest true "Termination reason"
