...
Ensure all topic definitions in modules/kafka_topics/main.tf match the RequestTopic, ResponseTopic, etc., constants in your Go code and the TopicDefinition logic in platform/kafka/topic_manager.go.