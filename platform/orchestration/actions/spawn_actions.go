...
func spawnAgentKubernetesJobFromDefinition(ctx context.Context, agentID string, agentDef *AgentDefinition, clientID string, logger *zap.Logger) (string, error) {
	...
	envList = append(envList, []corev1.EnvVar{
		...
		{Name: "SERVICE_INFRASTRUCTURE_CLIENTS_DATABASE_HOST", Value: os.Getenv("CLIENTS_DB_HOST")},
		{Name: "SERVICE_INFRASTRUCTURE_CLIENTS_DATABASE_PORT", Value: os.Getenv("CLIENTS_DB_PORT")},
		{Name: "SERVICE_INFRASTRUCTURE_CLIENTS_DATABASE_USER", Value: os.Getenv("CLIENTS_DB_USER")},
		{Name: "SERVICE_INFRASTRUCTURE_CLIENTS_DATABASE_DB_NAME", Value: os.Getenv("CLIENTS_DB_NAME")},
		{Name: "SERVICE_INFRASTRUCTURE_TEMPLATES_DATABASE_HOST", Value: os.Getenv("TEMPLATES_DB_HOST")},
		{Name: "SERVICE_INFRASTRUCTURE_TEMPLATES_DATABASE_PORT", Value: os.Getenv("TEMPLATES_DB_PORT")},
		{Name: "SERVICE_INFRASTRUCTURE_TEMPLATES_DATABASE_USER", Value: os.Getenv("TEMPLATES_DB_USER")},
		{Name: "SERVICE_INFRASTRUCTURE_TEMPLATES_DATABASE_DB_NAME", Value: os.Getenv("TEMPLATES_DB_NAME")},
	}...)
