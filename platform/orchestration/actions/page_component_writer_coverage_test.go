...
var exemptWriters = map[string]string{
	...
	"fix_forced_text_colours_action.go": "colour rewrite inside <style> blocks/declarations; never touches element attributes [MEASURED 2026-08-14: colour_fixer_class_preservation_test.go]",
	"fix_harcoded_colours_action.go":    "colour rewrite inside <style> blocks/declarations; never touches element attributes [MEASURED 2026-08-14: colour_fixer_class_preservation_test.go]",
