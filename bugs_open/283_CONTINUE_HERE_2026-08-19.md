...
1. **Verify the roll at the DIGEST** (RUNBOOK §1) AND
   `git merge-base --is-ancestor 35d2e0f9c <pod revision>` (gate-hardened) AND `git merge-base --is-ancestor 79fa79fb4 <pod revision>` (shared-guard stub check) — NOT ffef54338; v1.0.1315 lacks both hardenings.
