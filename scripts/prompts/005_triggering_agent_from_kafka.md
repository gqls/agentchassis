...
Core concept: Agents don't exist until spawned
Message structure: Headers, config, input_data
Spawn → Call → Complete pattern: The minimal workflow
Role matching: spawn role must match call target_role
Input mapping: How data flows between steps
Chaining agents: Multiple spawn/call sequences
