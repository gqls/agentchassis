...
echo "========================================="
echo "Manual code-indexer trigger (§7C reindex)"
echo "========================================="
...
echo "  kubectl -n ai-persona-system describe pod \$(kubectl -n ai-persona-system get pods -o name | grep code-indexer | head -1 | cut -d/ -f2) | grep -A3 GITHUB_READ_TOKEN"
echo ""
