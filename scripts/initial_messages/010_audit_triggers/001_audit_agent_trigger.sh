...
-H responses_topic=system.agent.generic.responses \
-H timestamp=$TIMESTAMP <<JSON
{"action":"orchestrate","config":{"agent_type":"image-build-handler"},"input_data":{"site_id":"00ff3af5-dad8-4770-9f70-3edc267a3c92","domain":"robot-hands.com","item_type":"needs_imagery","spec":{"scope":"site","key":"logo","kind":"logo","asset_key":"logo_2h_test","purpose":"logo","prompt":"Minimalist robotic gripper logomark, geometric, monochrome","brand_update":false}}}
JSON
...
{"action":"orchestrate","config":{"agent_type":"image-build-handler"},"input_data":{"site_id":"00ff3af5-dad8-4770-9f70-3edc267a3c92","domain":"robot-hands.com","item_type":"unfulfilled_hero_variant","spec":{"purpose":"hero","asset_key":"hero_about","prompt":"A wide-angle view of a modern automated production line with multiple robotic arms, each fitted with different gripper types — one pneumatic parallel jaw, one vacuum array, one magnetic lifter, one soft-robotic finger. Dark, atmospheric industrial lighting with blue accent highlights. Conveys the breadth of gripper technologies the platform covers."}}}
...
{"action":"orchestrate","config":{"agent_type":"image-build-handler"},"input_data":{"site_id":"00ff3af5-dad8-4770-9f70-3edc267a3c92","domain":"robot-hands.com","item_type":"needs_logo","spec":{"check": "unfulfilled_image_prompt", "purpose": "hero_about", "prompt_key": "hero_about", "image_prompts": {"hero_about": "A wide-angle view of a modern automated production line with multiple robotic arms, each fitted with different gripper types — one pneumatic parallel jaw, one vacuum array, one magnetic lifter, one soft-robotic finger. Dark, atmospheric industrial lighting with blue accent highlights. Conveys the breadth of gripper technologies the platform covers."}, "original_pipeline": "design"}}}
new:
{"action":"orchestrate","config":{"agent_type":"image-build-handler"},"input_data":{"site_id":"00ff3af5-dad8-4770-9f70-3edc267a3c92","domain":"robot-hands.com","item_type":"needs_logo","spec":{"check": "unfulfilled_image_prompt", "purpose": "hero_about", "prompt_key": "hero_about", "image_prompts": {"hero_about": "A wide-angle view of a modern automated production line with multiple robotic arms, each fitted with different gripper types — one pneumatic parallel jaw, one vacuum array, one magnetic lifter, one soft-robotic finger. Dark, atmospheric industrial lighting with blue accent highlights. Conveys the breadth of gripper technologies the platform covers."}, "original_pipeline": "design"}}}
{"action":"orchestrate","config":{"agent_type":"image-build-handler"},"input_data":{"site_id":"00ff3af5-dad8-4770-9f70-3edc267a3c92","domain":"robot-hands.com","item_type":"needs_imagery","spec":{"scope":"site","key":"logo","kind":"logo","asset_key":"logo_2h_test","purpose":"logo","prompt":"Minimalist robotic gripper logomark, geometric, monochrome","brand_update":false}}}